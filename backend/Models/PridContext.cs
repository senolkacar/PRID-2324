...
public class PridContext : DbContext
{
    ...
    public void CreateUsers()
    {
        modelBuilder.Entity<Teacher>().HasData(
            new Teacher { Id = 2, Pseudo = "ben", Password = "ben", FirstName = "Benoît", LastName = "Penelle", Email="penelle@epfc.eu" },
            new Teacher { Id = 3, Pseudo = "bruno", Password = "bruno", FirstName = "Bruno", LastName = "Lacroix", Email="lacroix@epfc.eu" }
        );

        modelBuilder.Entity<Student>().HasData(
            new Student { Id = 4, Pseudo = "bob", Password = "bob", FirstName = "Bob", LastName="l'Eponge", Email="bob@epfc.eu" },
            new Student { Id = 5, Pseudo = "caro", Password = "caro", FirstName = "Caroline", LastName = "de Monaco", Email="caro@epfc.eu" }
        );
    }
